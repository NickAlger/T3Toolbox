...
tangent_randn                   = ft.partial(t3m.tangent_randn, randn=lambda s: jnp.array(np.random.randn(*s))) # should convert this to pure jax
orthogonal_gauge_projection     = ft.partial(t3m.orthogonal_gauge_projection, xnp=jnp)
