...
def t3_to_ut3(
    ...
    uniform_basis_cores = pack_matrices(basis_cores)
    uniform_tt_cores = pack_uniform_tensor_train(tt_cores)
    return uniform_basis_cores, uniform_tt_cores
...
def ut3_to_t3(
    ...
    basis_cores = unpack_matrices(uniform_basis_cores, tucker_ranks, shape)
    tt_cores = unpack_uniform_tensor_train(uniform_tt_cores, tt_ranks, tucker_ranks)
