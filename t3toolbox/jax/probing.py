...
compute_weighted_detas          = ft.partial(t3p.compute_weighted_detas, xnp=jnp)
assemble_tangent_probes         = ft.partial(t3p.assemble_weighted_tangent_zs, xnp=jnp)
compute_weighted_deta_tildes    = ft.partial(t3p.compute_weighted_deta_tildes, xnp=jnp)
compute_weighted_tau_tildes     = ft.partial(t3p.compute_weighted_tau_tildes, xnp=jnp)
compute_weighted_sigma_tildes   = ft.partial(t3p.compute_weighted_sigma_tildes, xnp=jnp)
compute_weighted_dxi_tildes     = ft.partial(t3p.compute_weighted_dxi_tildes, xnp=jnp)
